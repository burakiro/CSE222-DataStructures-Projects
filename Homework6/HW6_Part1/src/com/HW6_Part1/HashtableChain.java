...
public class HashtableChain < K, V >
  ...
  private static final double LOAD_THRESHOLD = 10.0;
  ...
  public V put(K key, V value) {
    ...
    if (table[index] == null) {
      ...
      table[index] = new BST (200000);
    }

    //table[index].add((Comparable) value);
  ...
  public void rehash() {
    ...
    table = new BST[2 * oldTable.length + 1];
    int oldSize = numKeys;
